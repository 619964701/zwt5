<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp\www\zwt5\public/../application/index\view\index\location.html";i:1503452624;s:65:"D:\wamp\www\zwt5\public/../application/index\view\Public\top.html";i:1503021190;s:68:"D:\wamp\www\zwt5\public/../application/index\view\Public\footer.html";i:1503386494;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<meta name="description" content="竹签,竹签文化,竹文投,竹文品牌,这是百度地图地址">
<title>联系我们</title>
...
<link rel="stylesheet" href="/static/index/css/contact/contact.css">
<!--引用百度地图API-->
<style type="text/css">
...
<!-- 首页头部开始 -->
	...
	<div class="page-container">
		<div class="pageAbsout">
	        ...
	        <a href="" class="cur">联系方式</a>
		</div>
		<div class="webbg">
	        <div class="commonWeb contactList">
	            <div class="contactAdd">
	                <h4 class="conname">竹文品牌管理（上海）有限公司</h4>
	                <p>地 &nbsp;址：上海市嘉定区南翔镇银翔路515号2号楼</p>
	                <p><span>电话：86-755-22660000</span></p><p><span>传真：86-755-22660066</span></p><p><span><span>邮编：</span><span>201802</span></span></p><p><br></p>
	            </div>   
	        </div>   
      </div>
      <!--百度地图容器-->
	  <div style="width:1060px;height:550px;border:#ccc solid 1px;" id="dituContent"></div>
  </div>
  <br/>
  <p class="mapmore">
	  <a href="#" class="contactMore" onClick="javascript :history.back(-1);">返回</a>
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=er7N28kg3GUyxcjAMGcLjOi8ffOLzKVL"></script>
  ...
  <script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.331084,31.296739);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"竹文品牌管理（上海）有限公司",content:"竹签文化传媒（上海）有限公司",point:"121.331592|31.297804",isOpen:1,icon:{w:21,h:21,l:92,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
